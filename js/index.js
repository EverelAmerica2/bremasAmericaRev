...
const printFooter = function(){
    ...
    <div class='footer-box1'>
            <div class='footer-center-box'>
                <p class='footer-title'>Bremas America</p>
        ...
        <div class="footer-box3">
            <div class='footer-logo'><img src='./img/bremas-america-logo.png' atl='bremas america logo' /></div>
        </div>
        <div class='footer-box4'>Bremas America &copy; ${year}<br/>
